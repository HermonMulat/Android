    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putStringArrayList(OrderDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringArrayListExtra(OrderDetailFragment.ARG_ITEM_ID));
            arguments.putString(OrderDetailFragment.ARG_NAME,
                    getIntent().getStringExtra(OrderDetailFragment.ARG_NAME));
            arguments.putString(OrderDetailFragment.ARG_KEY,
                    getIntent().getStringExtra(OrderDetailFragment.ARG_KEY));
