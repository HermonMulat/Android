package hu.ait.wildcatmenu.adapter;
...
public class FoodRecyclerAdapter
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (context instanceof ConfirmActivity || context instanceof OrderListActivity){
